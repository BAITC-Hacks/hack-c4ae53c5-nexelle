const formatKey = {
  Course: 'course', Workshop: 'workshop', Event: 'event', Mentoring: 'mentoring',
  course: 'course', workshop: 'workshop', meetup: 'event', mentoring: 'mentoring',
  online: 'event', offline: 'event', self_paced: 'course',
}
